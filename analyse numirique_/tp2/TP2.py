...
def rec_dichotomie(f, a, b, tol, iterations=None):
    ...
    if abs(b - a) <= tol:
        ...
        return rec_dichotomie(f, a, c, tol, iterations)
    else:
        return rec_dichotomie(f, c, b, tol, iterations)


def rec_point_fixe(choice, x0, tol, iterations=None):
    if iterations is None:
        iterations = []
    ...
    return rec_point_fixe(choice, x1, tol, iterations)


def rec_newton(f, df, x0, tol, iterations=None):
    if iterations is None:
        iterations = []
    ...
    if abs(x1 - x0) < tol:
        return x1, iterations
    return rec_newton(f, df, x1, tol, iterations)
    ...
    while True:
        ...
        while True:
            ...
            if methode_choisie == 1:
                print(
                    f"Résolution de la fonction choisie avec la méthode de la dichotomie sur l'intervalle {intervalle}"
                )
                while True:
                    meth = menu_meth()
                    if meth == 2:
                        racine, iterations = dichotomie(
                            f, intervalle[0], intervalle[1], tol
                        )
                        print("Racine:", racine)
                        print("Iterations:", iterations)
                    elif meth == 1:
                        racine, iterations = rec_dichotomie(
                            f, intervalle[0], intervalle[1], tol
                        )
                        print("Racine:", racine)
                        print("Iterations:", iterations)
                ...
                print(
                    f"Résolution de la fonction choisie avec la méthode du point fixe."
                )
                while True:
                    meth = menu_meth()
                    if meth == 2:
                        racine, iterations = point_fixe(fonction_choisie, 2, tol)
                        print("Racine:", racine)
                        print("Iterations:", iterations)
                    elif meth == 1:
                        racine, iterations = rec_point_fixe(fonction_choisie, 2, tol)
                        print("Racine:", racine)
                        print("Iterations:", iterations)
                    elif meth == 3:
                        break
                ...
                while True:
                    meth = menu_meth()
                    if meth == 2:
                        racine, iterations = newton(f, df, 1, tol)
                        print("Racine:", racine)
                        print("Iterations:", iterations)
                    elif meth == 1:
                        racine, iterations = rec_newton(f, df, 1, tol)
                        print("Racine:", racine)
                        print("Iterations:", iterations)
                    elif meth == 3:
                        break
